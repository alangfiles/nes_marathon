...
#define TARGET_FAST_SPEED_FP 556
...
unsigned char secret_cursor_index;
unsigned char secret_steps_digits[5];
unsigned char secret_time_hours;
unsigned char secret_time_minutes_tens;
unsigned char secret_time_minutes_ones;
unsigned char secret_start_override_active;
