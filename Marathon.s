...
;
	jmp     L2276
L2277:	lda     _time_since_button_press
	cmp     #$79
	bcs     L2278
;
; motion = WALKING;
...
;
L2280:	lda     _sprite_frame_counter
	cmp     #$2D
	bcs     L2176
;
...
; if(step_button_lockout > 0){
;
L2290:	lda     _step_button_lockout
	beq     L2291
;
; --step_button_lockout;
;
